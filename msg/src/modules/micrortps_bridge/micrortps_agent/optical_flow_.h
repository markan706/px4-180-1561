...
public:
     ...
     */
    inline eProsima_user_DllExport void max_flow_rate(float _max_flow_rate)
    {
     ...
     */
    inline eProsima_user_DllExport float max_flow_rate() const
    {
     ...
     */
    inline eProsima_user_DllExport float& max_flow_rate()
    {
        return m_max_flow_rate;
    }
    /*!
     ...
     */
    inline eProsima_user_DllExport void min_ground_distance(float _min_ground_distance)
    {
     ...
     */
    inline eProsima_user_DllExport float min_ground_distance() const
    {
     ...
     */
    inline eProsima_user_DllExport float& min_ground_distance()
    {
        return m_min_ground_distance;
    }
    /*!
     ...
     */
    inline eProsima_user_DllExport void max_ground_distance(float _max_ground_distance)
    {
     ...
     */
    inline eProsima_user_DllExport float max_ground_distance() const
    {
     ...
     */
    inline eProsima_user_DllExport float& max_ground_distance()
    {
        return m_max_ground_distance;
    }
    /*!
